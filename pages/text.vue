  ...
  <main>
    ...
    <div class="bg-gray-25 min-h-screen p-6">
      <div class="max-w-4xl mx-auto">
        <!-- Greeting Section -->
        <h1 ref="greetingRef" class="text-lg text-[#1D2739] font-medium mb-6">
          {{ greeting ?? "Hello" }}, {{ user.firstName ?? "Nil" }}
          {{ user.lastName ?? "Nil" }}
        </h1>

        <!-- Setup Actions Section -->
        <div ref="setupActionsRef" class="space-y-2 mb-8">
          <div
        ...
        <div
          ...
          class="flex justify-between mb-8 rounded-lg"
        >
          <div
            v-for="payment in paymentActions"
            :key="payment.title"
            class="w-1/3 cursor-pointer bg-white p-6 text-center"
          >
            <img
        ...
        <!-- Recent Applications -->
        <div ref="recentApplicationsRef">
          <h2 class="text-base font-medium text-[#171717]">
            Recent applications
          </h2>
          <RecentApplications />
        </div>
        ...
        >
          ...
          >
            ...
            <div>
              <h3 class="text-sm font-medium text-[#1D2739]">
                Rental applications
              </h3>
              <p class="text-[#667185] text-xs font-light gap-x-2">
        ...
        <section ref="upcomingActivitiesRef" class="mt-10">
          <div
          ...
          <div class="pt-3 rounded-lg">
            ...
            >
              <img
                src="@/assets/icons/event-illustrations.svg"
                alt="No events"
            ...
            <div v-else>
              ...
              >
                ...
                <span
                  class="text-xs font-semibold rounded-full text-[#DD900D] bg-[#FEF6E7] px-3 py-1"
        ...
        <section ref="recentTransactionsRef" class="mt-10">
          <div
            class="flex justify-between items-center bg-white rounded-md py-5 px-4"
          >
            <h3 class="text-base font-medium text-[#171717]">
...
const setupActionsRef = ref(null);
const paymentActionsRef = ref(null);
const recentApplicationsRef = ref(null);
const rentalApplicationsRef = ref(null);
const upcomingActivitiesRef = ref(null)
const recentTransactionsRef = ref(null)

// Initialize the user and greeting
const { user } = useUser();
const { greeting } = useGreeting();

// Setup data for actions and payments
const setupActions = ref([
  ...
  {
    title: "Set up your payment preference",
    description: "Search for homes that suit your preferences.",
    path: "#",
  },
]);
