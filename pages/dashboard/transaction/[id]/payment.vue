<template>
  ...
  <section v-if="!loading && Object.keys(transactionObj)?.length" class="">
    <nav class="flex items-center space-x-2 mx-auto max-w-2xl  my-4">
    ...
    <div class="max-w-2xl mx-auto">
      ...
      <section>
        <h2 class="text-sm font-medium py-3 bg-white rounded-lg border-[0.5px] border-gray-100 px-3 mb-3">
          Rent Details
        </h2>
      ...
      <section>
        <h2 class="text-sm font-medium py-3 bg-white rounded-lg border-[0.5px] border-gray-100 px-3 mt-8 mb-3">
          Transaction Details
        </h2>
