...
const requests = ref<Request[]>([
  { id: 1, type: 'Plumbing Issue', date: '2024-03-23', status: 'Upcoming' },
  { id: 2, type: 'Plumbing Service', date: '2024-03-23', status: 'Pending' },
  { id: 3, type: 'Electrical issues', date: '2024-03-23', status: 'Cancelled' },
  { id: 4, type: 'Appliance repair', date: '2024-03-23', status: 'Completed' },
  { id: 5, type: 'Electrical issues', date: '2024-03-23', status: 'Declined' },
  { id: 6, type: 'Plumbing Issue', date: '2024-03-24', status: 'Upcoming' },
  { id: 7, type: 'Plumbing Service', date: '2024-03-24', status: 'Pending' },
  { id: 8, type: 'Electrical issues', date: '2024-03-24', status: 'Cancelled' },
  { id: 9, type: 'Appliance repair', date: '2024-03-24', status: 'Completed' },
  { id: 10, type: 'Electrical issues', date: '2024-03-24', status: 'Declined' },
  { id: 11, type: 'Plumbing Issue', date: '2024-03-25', status: 'Upcoming' },
  { id: 12, type: 'Plumbing Service', date: '2024-03-25', status: 'Pending' },
  { id: 13, type: 'Electrical issues', date: '2024-03-25', status: 'Cancelled' },
  { id: 14, type: 'Appliance repair', date: '2024-03-25', status: 'Completed' },
  { id: 15, type: 'Electrical issues', date: '2024-03-25', status: 'Declined' },
]);

// State to store selected status filter
const selectedStatus = ref<string>('All requests');

// Filtered list of dates with requests
const requestDates = computed(() =>
  [...new Set(requests.value.map((req) => req.date))].sort()
);

// Filtered requests based on date and selected status
const filteredRequestsByStatus = (date: string) => {
  return requests.value.filter((req) =>
      req.date === date && (selectedStatus.value === 'All requests' || req.status === selectedStatus.value)
  );
...
// Handle selection change from HomeHeaderActions
const handleSelected = (status: string) => {
  selectedStatus.value = status;
};
</script> -->
