      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white p-4 py-6 rounded-lg mb-8 flex justify-between items-center">
          <div @click="router.push('/dashboard/rental-applications')" class="flex cursor-pointer items-center gap-x-3">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M15.416 13.3333H12.916M15.416 10H12.916" stroke="white" stroke-width="1.5"
                stroke-linecap="round" />
              <path d="M7.08398 11.6667H4.58398M7.08398 8.33333H4.58398M7.08398 5H4.58398" stroke="white"
        ...
        <div class="">
          ...
          <div v-if="!loadingRentals && rentalsList.length"
            class="grid mt-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 md:gap-6">
            <div v-for="rental in filteredRentals" @click="handleSelectedRental(rental)" :key="rental.id"
              ...
              <img v-if="!rental?.house?.images[0]?.length" class='h-72 w-full object-cover rounded-xl'
        ...
        <section class="mt-10">
          ...
          <div class="pt-3 rounded-lg">
            <div v-if="!paymentList?.length && !loading"
              class="text-center text-gray-500 py-12 bg-white rounded-md py-5 px-4">
              <img src="@/assets/icons/transaction-illustration.svg" alt="No transactions" class="mx-auto mb-2" />
...
const updateTourState = (title: string) => {
  useRouter().push(`${title}`)
  if (title === 'dashboard/listings') {
    profileObj.hasTakenTour = true;
    console.log('tour')
  }
}
