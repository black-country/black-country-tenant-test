  ...
  <MessagingView>
    <div>
      ...
      <div class="relative -mt-32 h-screen flex lg:flex-row flex-col">
        ...
        >
          <section
            class="lg:hidden flex items-center justify-between w-full px-2"
          >
            <div class="flex items-center justify-between">
              <button class="lg:hidden p-2" @click="openSideNav = false">
                ...
                >
                  ...
                  />
                  <path
                    d="M20.5 13.3125C20.5 13.3125 15.5 16.9949 15.5 18.3125C15.5 19.6302 20.5 23.3125 20.5 23.3125"
                    stroke="#1D2739"
                    stroke-width="1.5"
          ...
          <div
            class="flex items-center space-x-2 p-2 border-b-[0.5px] border-gray-100 relative py-3.5"
          >
            <div
            ...
            <button
              ...
              class="bg-[#EAEAEA] p-3 rounded-lg transition-colors"
            >
              <svg
                width="20"
                height="20"
          ...
          <div
            v-if="!loadingActiveChats && activeChatsList.length"
        ...
        <!-- Chat Window -->
        <div
          class="flex-1 flex flex-col bg-white h-full"
          :class="{ hidden: !selectedUser && !isDesktop }"
        >
          <div
            class="flex items-center justify-between border-b-[0.5px] border-gray-200"
          >
          ...
          <div
            v-if="!loadingRoomChats && roomChatsList.length"
      ...
      >
        <div
          class="absolute ml-10 lg:ml-72 mt-4 top-10 w-80 bg-white rounded-lg border-[0.5px] border-gray-100 shadow"
        >
          <ul>
            <li
              class="flex items-center justify-between text-sm px-4 py-2 mb-2 border-b text-[#1D2739] last:border-b-0 border-gray-100 cursor-pointer"
