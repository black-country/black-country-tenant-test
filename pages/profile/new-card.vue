          ...
          <div class="mt-6 space-y-4">
            ...
            <div class="relative">
              ...
              <div class="flex items-center space-x-2">
                ...
                />
                <span v-if="resolving" class="loader"></span>
              </div>
            </div>
            ...
            <button @click="handleAddCard" class="text-white disabled:cursor-not-allowed disabled:opacity-25 font-medium rounded-md px-6 py-3 bg-[#292929]">{{ processing ? 'processing...' : 'Link Card' }}</button>
          </div>
          </div>
        </div>
      </div>
...
const { resolveBank, loading: resolving, bankObj } = useResolveBank()
