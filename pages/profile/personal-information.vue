<template>
   <main>  
    ...
    <div class="min-h-screen flex flex-col justify-between">
      <div  v-if="currentStep === 1" class="max-w-3xl mx-auto bg-white p-6">
      ...
      <div v-if="currentStep === 2" class="max-w-2xl mx-auto bg-white p-6 w-full">
        <div class="text-gray-500 flex-col">
          <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="36" height="36" rx="18" fill="#EAEAEA"/>
            <path d="M20.5 13C20.5 13 15.5 16.6824 15.5 18C15.5 19.3177 20.5 23 20.5 23" stroke="#1D2739" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div  v-if="currentStep === 3" class="max-w-2xl mx-auto bg-white p-6 w-full">
        <div class="text-gray-500 flex-col">
          <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="36" height="36" rx="18" fill="#EAEAEA"/>
            <path d="M20.5 13C20.5 13 15.5 16.6824 15.5 18C15.5 19.3177 20.5 23 20.5 23" stroke="#1D2739" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div v-if="currentStep === 4" class="max-w-2xl mx-auto bg-white p-6 w-full">
      <div class="text-gray-500 flex-col">
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="36" height="36" rx="18" fill="#EAEAEA"/>
          <path d="M20.5 13C20.5 13 15.5 16.6824 15.5 18C15.5 19.3177 20.5 23 20.5 23" stroke="#1D2739" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
