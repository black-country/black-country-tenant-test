<template>
      ...
      <form @submit.prevent="handleResendOtp" class="w-full max-w-md text-center">
       <div class="mb-3 flex justify-center items-center">
        ...
        <p class="text-[#667185] mb-8">
            Kindly enter the OTP sent to 23409****34 and  ag@gmail.com to proceed to app move-in
        </p>
      <section>
     ...
     <div class="pt-10">
      <button :disabled="loading || !isOtpComplete" type="submit" class="bg-[#292929] disabled:cursor-not-allowed disabled:opacity-25 text-white py-4 px-6 rounded-lg w-full mb-4">
        ...
        <p class="text-gray-500">
          <a @click="handleResendOtp" href="#" class="text-[#667185]">{{ resending ? 'processing...' : 'Resend code'}}</a>
        </p>
      </form>
    </div>
  </template>
  ...
  const focusNext = (index: number) => {
    ...
    credential.otpCode.value = otp.value.join('')
  }
