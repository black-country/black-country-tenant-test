<template>
  <div class="relative">
    ...
    <div
      ref="dropdownRef"
      v-if="openDropdown"
      class="absolute right-0 mt-2 w-56 bg-white divide-y-[0.5px] divide-gray-300 rounded-lg shadow-lg py-2 z-50"
    >
      <NuxtLink
        to="/profile"
        @click.native="closeDropdown"
        class="flex items-center px-4 py-3 text-[#1D2739] space-x-3 hover:bg-gray-50 transition-colors"
      >
        <svg
          width="20"
          height="20"
      ...
      <button
        ...
        class="flex items-center w-full px-4 py-3 text-[#1D2739] space-x-3 hover:bg-gray-50 transition-colors"
      >
  ...
  <CoreModal :isOpen="showBLogoutModal" @close="showBLogoutModal = false">
