        ...
        <div class="hidden lg:flex items-center pl-4 justify-between w-full">
          <div class="flex items-center space-x-6">
            ...
            <div class="flex space-x-6">
              <NuxtLink data-intro="Dashboard" ref="dashboardRef"
                :class="[route.path === '/dashboard' ? 'bg-[#1D1D1D]' : '']" to="/dashboard"
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M15 12.5003H10M5.83333 12.5003H5M7.91667 11.667V13.3337" stroke="#D0D5DD" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <span class="text-sm">Dashboard</span>
              </NuxtLink>
              <NuxtLink data-intro="Listings" ref="listingsRef"
                :class="[route.path === '/dashboard/listings' ? 'bg-[#1D1D1D]' : '']" to="/dashboard/listings"
              ...
              <NuxtLink data-intro="My Home" to="/dashboard/home"
                class="flex items-center space-x-1 px-3 rounded-lg text-gray-300 hover:text-white">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <NuxtLink data-intro="Messages" to="/dashboard/messages"
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    stroke="#D0D5DD" stroke-width="1.5" stroke-linejoin="round" />
                  <path d="M9.99606 10H10.0035M13.3256 10H13.3331M6.66644 10H6.67392" stroke="#D0D5DD" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            ...
            <nav class="flex flex-1 flex-col">
              <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                >
                  ...
                  <NuxtLink to="/profile"
                    class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-800 hover:text-white">
                    <img :src="user?.profilePicture" alt="logout" class="h-6 w-6 rounded-full bg-gray-800" />
