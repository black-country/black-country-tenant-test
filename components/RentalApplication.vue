   ...
   <main>
     <!-- <div v-if="!loading && Object.keys(propertyObj?.rentalApplication).length" class="max-w-3xl mx-auto p-4"> -->
      ...
      <div class="mb-6 mt-16 ">
        <div v-if="propertyObj?.images" class="flex items-center gap-4">
          <div class="border-[0.5px] border-gray-100 rounded-lg rounded-xl">
            <img :src="propertyObj?.images[0]" alt="Room preview" class="w-20 border-[0.5px] border-gray-100 rounded-lg rounded-xl h-20 object-cover" />
          </div>
          <div>
      ...
      <div class="mb-6 border-[0.5px] py-4 px-3 rounded-lg border-gray-100 flex justify-between items-center">
        ...
        <div v-if="propertyObj.rentalApplication?.room?.isMaster" class="inline-flex items-center gap-2 px-3 py-3 bg-[#FEF6E7] text-xs text-[#DD900D] rounded-full mt-2">
