<template>
 <main>
    <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-5 lg:p-0" v-if="!loadingProperties && propertiesList.length"
  >
    <div
  ...
  >
    <img
      ...
      class=""
    />
    <p class="text-[#1D2739]">No Bookmarked properties available</p>
  </div>
 </main>
</template>
