        ...
        <div v-for="option in sortOptions" :key="option.id"
          ...
          <div class="relative flex items-center">
            <input
              ...
              @change="toggleOption(selectedSortOptions, option.id)"
              class="h-5 w-5 rounded border-gray-300 text-green-600 focus:ring-0 focus:ring-offset-0"
            >
            <div v-if="selectedSortOptions.has(option.id)"
    ...
    <div class="space-y-3">
      ...
      <div class="space-y-2 bg-white rounded-md border-[0.5px] border-gray-50 py-3 p-1">
        <div v-for="type in propertyTypes" :key="type.id"
             class="flex justify-between items-center">
          <label :for="'property-' + type.id" class="ml-3 text-sm text-gray-700">{{ type.label }}</label>
          <div class="relative flex items-center">
            <input
              :id="'property-' + type.id"
              type="checkbox"
      ...
      <button class="text-sm text-green-600 mt-2">View more</button>
    </div>
    ...
    <div class="space-y-3">
      ...
      <div class="space-y-2 bg-white rounded-md border-[0.5px] border-gray-50 py-3 p-1">
        <div v-for="amenity in amenities" :key="amenity.id"
             class="flex justify-between items-center">
          <label :for="'amenity-' + amenity.id" class="ml-3 text-sm text-gray-700">{{ amenity.label }}</label>
          <div class="relative flex items-center">
            <input
