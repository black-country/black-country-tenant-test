<template>
    <div class="max-w-lg mx-auto p-8 bg-white">
      ...
      <div class="text-center mb-6 flex justify-center items-center flex-col gap-y-3 pb-4">
        <!-- <img src="/path/to/logo.png" alt="Logo" class="h-16 mx-auto mb-4" /> -->
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="mb-4 relative">
          ...
          <div @click="toggleShowPassword" class="absolute inset-y-0 right-4 top-6 flex items-center cursor-pointer">
            <!-- <svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.522 5 12 5c4.478 0 8.268 2.943 9.542 7-.942 3.25-3.563 5.8-6.835 6.485M15 12a3 3 0 01-6 0" />
            </svg> -->
            <svg  v-if="!showPassword" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.3332 6.66669C18.3332 6.66669 14.9998 11.6667 9.99984 11.6667C4.99984 11.6667 1.6665 6.66669 1.6665 6.66669" stroke="#1D2739" stroke-width="2" stroke-linecap="round"/>
                <path d="M12.5 11.25L13.75 13.3333" stroke="#1D2739" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <!-- <button
          ...
          class="w-full py-4 px-4 bg-[#292929] mt-6 text-white rounded-md shadow-sm font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2"
        >
          Continue
        </button> -->
        <NuxtLink to="/login"
