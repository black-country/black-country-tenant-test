      ...
      <div class="space-y-6">
        <section class="grid grid-cols-2 gap-6 w-full">
          ...
          <div>
            ...
            <input v-model="guarantorInfo.fullName" type="text"
          ...
          <div>
            ...
            <select v-model="guarantorInfo.relationship"
              class="w-full p-3.5 text-sm text-[#98A2B3] outline-none rounded-lg bg-[#F0F2F5] border border-[0.5px] border-gray-100">
        ...
        <div>
          ...
          <input v-model="guarantorInfo.email" type="email"
            class="w-full p-3.5 text-sm text-[#98A2B3] outline-none rounded-lg bg-[#F0F2F5] border border-[0.5px] border-gray-100"
        ...
        <div>
          ...
          <!-- <input v-model="guarantorInfo.phone" type="tel"
            class="w-full p-3.5 text-sm text-[#98A2B3] outline-none rounded-lg bg-[#F0F2F5] border border-[0.5px] border-gray-100"
        ...
        <div>
          ...
          <input v-model="guarantorInfo.additionalPhone" type="tel"
            class="w-full p-3.5 text-sm text-[#98A2B3] outline-none rounded-lg bg-[#F0F2F5] border border-[0.5px] border-gray-100"
            placeholder="01234567890" />
        </div>
        ...
        <div>
          ...
          <select v-model="guarantorInfo.idType"
            class="w-full p-3.5 text-sm text-[#98A2B3] outline-none rounded-lg bg-[#F0F2F5] border border-[0.5px] border-gray-100">
        ...
        <div v-if="guarantorInfo.idType">
          ...
          <div
            ...
            <div v-else class="relative">
              ...
              <button @click="clearUpload" class="absolute top-2 right-2 bg-red-500 text-white rounded-full p-1">
                ×
              </button>
            </div>
          </div>
        ...
        <div class="bg-white fixed bottom-0 left-0 right-0 px-6 py-4 flex justify-center border-[0.5px]">
          <div class="max-w-2xl w-full flex justify-between">
            <button class="px-6 py-3 text-sm rounded-md bg-white border text-[#292929]" @click="$emit('back')">
              Back
            </button>
