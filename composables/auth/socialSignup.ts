...
//       create: {
//         firstName:credential.create.value.firstName,
//         lastName: credential.create.value.lastName,
//         password: credential.create.value.password
//       },
//     })) as any;
...
//     credential.create.value.firstName = data.firstName;
//     credential.create.value.lastName = data.lastName;
//     credential.create.value.password = data.password;
//   };

//   return { credential, social_signup, loading, setAuthObj };
// };
