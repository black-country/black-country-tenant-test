...
export const useUser = () => {
	...
	const isLoggedIn = computed({
		get: () => {
			...
			return runtimeData?.user?.value != null && typeof runtimeData.user.value === 'object';
		},
		set: () => { }
	});
	...
	// const setTempOtp = (tempOtp: string) => {
	// 	localStorageData.tempOtp.value = tempOtp;
	// 	runtimeData.tempOtp.value = tempOtp;
	// };
	...
	return { id, isLoggedIn, isEmailVerified, createUser, ...runtimeData, logOut, updateUser, setToken
		// , setTempOtp 
	};
};
